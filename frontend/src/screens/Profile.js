      ...
      <div className="profile-content">
        ...
        {user?.admin === 1 && (
          <p className="admin_Para">
            As an admin, all course PDFs are freely available on the admin page.
            If you want to buy, please proceed to purchase.
          </p>
        )}
            ...
            courseData.map((course, index) => (
              <div className="course-box" key={index}>
                <div className="course-info">
                  ...
                  <a
                    href={`http://localhost:5000/api/courses/download/${course.pdfName}`} // Download PDF route
